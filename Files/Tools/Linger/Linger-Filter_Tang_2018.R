...
print("-----------------------")      
print(paste('Name of the output filtered text file:',output.txt.name, sep=' '))
print("-----------------------")   
print(paste('Name of the output outliers text file:',output.outliers.txt.name, sep=' '))
print("-----------------------")    
...
print("Please cite: Tang, K. (2014--2018). Linger Toolkit. www.kevintang.org/Tools.html.")
