...
#                                                                  
#  Author: Kevin Tang                                             
#  Latest revision: 29 March 2018
#  Version =  1.0.2
#  Email: linguist@kevintang.org
#  www.kevintang.org
#  Twitter: http://twitter.com/tang_kevin​
#
#  Please cite:
#  Tang, K. (2014--2018). Linger Toolkit. www.kevintang.org/Tools.html
#
...
#  - Version 1.1: 29 March 2018: Fixed an issue if the last trial is one that misses the word final anchor ? then an error will occur
#  if currUnique != currUnique2: UnboundLocalError: local variable 'currUnique' referenced before assignment


Version =  "1.1"
citation = 'Tang, K. (2014--2018). Linger Toolkit. www.kevintang.org/Tools.html'
####################################################################
import optparse
import os
import codecs
...
def main():
    p = optparse.OptionParser(usage="%prog [-i] [-o] [-e] [-u] [-l]", version = "%prog Version: " + Version + '\nCitation: ' + citation)
    ...
    #dat_path_folder = "/home/kevintang/Downloads/TestingLinger/emil/"
    ...
    for currLine_nr, currLine in enumerate(new_dat_lines_rev):
        ...
        # this is to fix the last line missing ? bug
        else:
            if currLine_nr == 0:
                currUnique = u'MISSING?INLASTLINE'
    ...
    with codecs.open(csv_path,'w','utf-8') as f:
        ...
        print '====================================='           
        print 'Please cite:'
        print 'Tang, K. (2014--2018). Linger Toolkit. www.kevintang.org/Tools.html.'         
        print '=====================================' 
